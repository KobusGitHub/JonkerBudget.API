...
using JonkerBudget.WebApi.Models;
using JonkerBudget.WebApi.Providers;
using JonkerBudget.WebApi.Results;
...
namespace JonkerBudget.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        IUserRepository _iusersRepository;

        public AccountController(IUserRepository iusersRepository)
        {
        ...
        {
            string commsApiUrl = ConfigurationManager.AppSettings["CommsApiAddress"];
            string commsApiUsername = ConfigurationManager.AppSettings["CommsApiUsername"];
            string commsApiPassword = ConfigurationManager.AppSettings["CommsApiPassword"];
            string commsApiFromAddress = ConfigurationManager.AppSettings["CommsApiFromAddress"];

            try
            {

                using (CommsApi.Client.CommsApi commsApi = new CommsApi.Client.CommsApi(commsApiUrl, commsApiUsername, commsApiPassword))
                {
                    string bodyText = "";
                    ...
                    if (!user.IsAdUser)
                    {
                        ...
                        <p>
                            ...
                            <br />
                            <br />
                               You have just been set up on the <strong>SG Notify System</strong>
                            <br />
                            <br />
                            ...
                            <br />
                               Regards,
                            <br />
                            SG Notify Services<br />
                    
                        </p>", user.FirstName + "  " + user.Surname,user.UserName,password);
                        ...
                        <p>
                            ...
                            <br />
                            <br />
                              You have just been set up on the <strong>SG Notify System</strong> your valid Active Directory Credentials will be used to login
                            <br />
                            <br />
                            Regards, <br />
                            SG Notify Services<br />
                    ...
                    var result = await commsApi.EmailApi.SendEmailBasicAsync(new SendEmailBasic()
                    {
                        Body = bodyText,

                        From = commsApiFromAddress,
                        IsBodyHtml = true,
                        Subject = "SG Notify Services",
                        To = user.Email
                    });
